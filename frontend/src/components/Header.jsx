  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
       ...
       <p>Simpy browse through our extensive list of trusted doctors, <br className='hidden sm:block'/>schedule your appointment, and experience hassle-free healthcare like never before.</p>
       
      </div>
      <a href='#speciality' className='flex items-center gap-2 bg-white px-8 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300   '>
